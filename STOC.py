...
def main():
    ...
    start_date = st.date_input("Start date:", value=pd.to_datetime('1924-01-01'), min_value=pd.to_datetime('1924-01-01'), max_value=yesterday)
    end_date = st.date_input("End date:", value=yesterday, min_value=start_date)
